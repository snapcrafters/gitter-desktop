...
the [snapcraft.yaml](https://github.com/snapcrafters/gitter-desktop/blob/master/snap/snapcraft.yaml)
upstream so Gitter Desktop can authoritatively publish future releases.
